...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format() {
		...
		// TODO créer un objet LocalDate à la date
	...
	public void test_localDate_format_with_hour() {
		...
		LocalDate localDate = LocalDate.parse( "11/03/2015", DateTimeFormatter.ofPattern("dd/MM/yyyy"));
	...
	public void test_with() {
		...
		// TODO utiliser la méthode of
		LocalDate localDate = LocalDate.parse("10/01/2000", DateTimeFormatter.ofPattern("dd/MM/yyyy"));
