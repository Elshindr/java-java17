...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        List<Person> result = filter(personList, (PersonPredicate) (guy) ->
            guy.getAge() >= 18
        );
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> result = filter(personList, (PersonPredicate) (guy) -> guy.getFirstname().equals("first_10"));
    ...
    public void test_filter_by_password() throws Exception {
        ...
        List<Person> result = filter(personList, (PersonPredicate) (guy) ->{
            ...
            if (guy.getAge() > 49 && DigestUtils.sha512Hex(guy.getPassword()).equals(passwordSha512Hex)){
                return true;
            }
